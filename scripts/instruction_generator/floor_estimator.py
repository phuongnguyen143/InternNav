...
class FloorEstimator:
    ...
    def estimate_local(
        ...
        u_small, u_large = estimate_up_axis_voting(points)
        up = u_small  # giả sử up axis là eigenvector nhỏ nhất
        ...
        for pcx in cx:
            for pcy in cy:
                ...
                # 5. Chỉ lấy bottom slice của patch
                h = patch_pts @ up
        ...
        # 8. Fit 1 global plane từ toàn bộ inliers để lấy normal nhất quán
